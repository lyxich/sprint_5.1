...
# Нашел и кликнул кнопку Выход
driver.find_element(By.XPATH, "//li[@class='Account_listItem__35dAP']//button[contains(@class, 'Account_button__14Yp3') and text()='Выход']").click()
